...
if (!defined('NULL_DATETIME')) {
	define('NULL_DATETIME', '0001-01-01 00:00:00');
}

if (!defined('NULL_DATE')) {
	define('NULL_DATE', '0001-01-01');
}
...
return [
	...
	"apcontact" => [
		...
		"fields" => [
			...
			"updated" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""]
		],
		"indexes" => [
			"PRIMARY" => ["url"],
			"addr" => ["addr(32)"],
	...
	"attach" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "creation time"],
			"edited" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "last edit time"],
	...
	"cache" => [
		...
		"fields" => [
			...
			"expires" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "datetime of cache expiration"],
			"updated" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "datetime of cache insertion"],
		],
		"indexes" => [
			"PRIMARY" => ["k"],
			"k_expires" => ["k", "expires"],
	...
	"contact" => [
		...
		"fields" => [
			"id" => ["type" => "int unsigned", "not null" => "1", "extra" => "auto_increment", "primary" => "1", "comment" => "sequential ID"],
			"uid" => ["type" => "mediumint unsigned", "not null" => "1", "default" => "0", "relation" => ["user" => "uid"], "comment" => "Owner User id"],
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"updated" => ["type" => "datetime", "default" => NULL_DATETIME, "comment" => "Date of last contact update"],
			...
			"last-update" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Date of the last try to update the contact info"],
			"success_update" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Date of the last successful contact update"],
			"failure_update" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Date of the last failed update"],
			"name-date" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"uri-date" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"avatar-date" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"term-date" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"last-item" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "date of the last post"],
			...
			"bd" => ["type" => "date", "not null" => "1", "default" => NULL_DATE, "comment" => ""],
	...
	"conv" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "creation timestamp"],
			"updated" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "edited timestamp"],
	...
	"conversation" => [
		...
		"fields" => [
			...
			"received" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Receiving date"],
		],
		"indexes" => [
			"PRIMARY" => ["item-uri"],
	...
	"event" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "creation time"],
			"edited" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "last edit time"],
			"start" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "event start time"],
			"finish" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "event end time"],
	...
	"gcontact" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"updated" => ["type" => "datetime", "default" => NULL_DATETIME, "comment" => ""],
			"last_contact" => ["type" => "datetime", "default" => NULL_DATETIME, "comment" => ""],
			"last_failure" => ["type" => "datetime", "default" => NULL_DATETIME, "comment" => ""],
			"archive_date" => ["type" => "datetime", "default" => NULL_DATETIME, "comment" => ""],
			...
			"gender" => ["type" => "varchar(32)", "not null" => "1", "default" => "", "comment" => ""],
			"birthday" => ["type" => "varchar(32)", "not null" => "1", "default" => NULL_DATE, "comment" => ""],
	...
	"gserver" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"last_poco_query" => ["type" => "datetime", "default" => NULL_DATETIME, "comment" => ""],
			"last_contact" => ["type" => "datetime", "default" => NULL_DATETIME, "comment" => ""],
			"last_failure" => ["type" => "datetime", "default" => NULL_DATETIME, "comment" => ""],
		],
		"indexes" => [
	...
	"inbox-status" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Creation date of this entry"],
			"success" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Date of the last successful delivery"],
			"failure" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Date of the last failed delivery"],
			"previous" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Previous delivery date"],
	...
	"intro" => [
		...
		"fields" => [
			...
			"datetime" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
	...
	"item" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Creation timestamp."],
			"edited" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Date of last edit (default is created)"],
			"commented" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Date of last comment/reply to this item"],
			"received" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "datetime"],
			"changed" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Date that something in the conversation changed, indicating clients should fetch the conversation again"],
	...
	"mail" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "creation time of the private message"],
		],
		"indexes" => [
			"PRIMARY" => ["id"],
			"uid_seen" => ["uid", "seen"],
	...
	"mailacct" => [
		...
		"fields" => [
			...
			"pubmail" => ["type" => "boolean", "not null" => "1", "default" => "0", "comment" => ""],
			"last_check" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
		],
		"indexes" => [
			"PRIMARY" => ["id"],
		]
	...
	"notify" => [
		...
		"fields" => [
			...
			"url" => ["type" => "varchar(255)", "not null" => "1", "default" => "", "comment" => ""],
			"photo" => ["type" => "varchar(255)", "not null" => "1", "default" => "", "comment" => ""],
			"date" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
	...
	"oembed" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "datetime of creation"],
		],
		"indexes" => [
	...
	"photo" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "creation date"],
			"edited" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "last edited date"],
			"title" => ["type" => "varchar(255)", "not null" => "1", "default" => "", "comment" => ""],
	...
	"push_subscriber" => [
		...
		"fields" => [
			...
			"last_update" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Date of last successful trial"],
			"next_try" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Next retrial date"],
			"renewed" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Date of last subscription renewal"],
	...
	"term" => [
		...
		"fields" => [
			...
			"guid" => ["type" => "varchar(255)", "not null" => "1", "default" => "", "comment" => ""],
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"received" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"global" => ["type" => "boolean", "not null" => "1", "default" => "0", "comment" => ""],
			"uid" => ["type" => "mediumint unsigned", "not null" => "1", "default" => "0", "relation" => ["user" => "uid"], "comment" => "User id"],
		],
		"indexes" => [
	...
	"thread" => [
		...
		"fields" => [
			...
			"created" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"edited" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"commented" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"received" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
			"changed" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => ""],
	...
	"user" => [
		...
		"fields" => [
			...
			"register_date" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "timestamp of registration"],
			"login_date" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "timestamp of last login"],
			...
			"account_expires_on" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "timestamp when account expires and will be deleted"],
			"expire_notification_sent" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "timestamp of last warning of account expiration"],
	...
	"workerqueue" => [
		...
		"fields" => [
			...
			"executed" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Execution date"],
			"next_try" => ["type" => "datetime", "not null" => "1", "default" => NULL_DATETIME, "comment" => "Next retrial date"],
